...
class _MovieDetailPageState extends State<MovieDetailPage> {
  ...
  late Future<ResultVideos> movieVideos; // Adicionando a variável
  ...
  fetchInitialData() {
    ...
    movieVideos = apiServices.getMovieVideos(widget.movieId); // Buscando vídeos
  }
        ...
        child: FutureBuilder(
          ...
          builder: (context, snapshot) {
            if (snapshot.hasData) {
              ...
              String voteAverage = "Avaliação: ${movie.voteAverage.toString()}";
                        ...
                        return videos.isEmpty
                            ...
                            : Column(
                                ...
                                children: [
                                  ...
                                  Container(
                                    height: 200, // Altura do vídeo
                                    // child: YouTubePlayer(
                                    //   controller: YouTubePlayerController(
                                    //     initialVideoId:
                                    //         videos[0].key, // O primeiro vídeo
